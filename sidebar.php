...
<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
				...
				?>
                        ...
                        <li <?php echo (Session::get('side-nav-active')==='view_students'?'class="treeview active"':'class=treeview') ?> >
                            <a href="#">
                                <i class="fa fa-graduation-cap"></i> <span>Students</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                            <li <?php echo (Session::get('side-nav-active-sub')==='add_student'?'class=active':'') ?> ><a href="add_student.php"><i class="fa fa-angle-double-right"></i> Add Student</a></li>
                                <li>
                                    <a href="view_students.php">
                                        <i class="fa fa-angle-double-right"></i> <span>View Students</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
